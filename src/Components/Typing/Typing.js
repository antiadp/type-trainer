	...
	render() {
		return (
			<div className="typing-wrapper">
				<Metrics WPM={this.state.WPM} CPM={this.state.CPM} ACC={this.state.ACC} timer={this.state.timer} />
				...
				<textarea
					...
					maxLength="500"
					readOnly={this.state.timer !== 0 ? false : true}
